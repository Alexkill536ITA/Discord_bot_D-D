    ...
    async execute(client, message, args) {
        ...
        try {
            if (message.member.roles.cache.some(r => config.role_base.includes(r.name)) || message.author.id == config.owner) {
                ...
                } else if (args[0] == "cambio_talento") {           // Event 1 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
                            if (args[1]) {
                                ...
                                var cursor_Scheda = get_Scheda_pg(autore.id);
                ...
                } else if (args[0] == "spedizione") {               // Event 2 fare
                ...
                } else if (args[0] == "strumento") {                // Event 3 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
                            if (args[1]) {
                                var autore = message.mentions.users.first();
                                var cursor_Scheda = get_Scheda_pg(autore);
                                cursor_Scheda.then(async function (result_pg) {
                                    if (result_pg != null) {
                                        var Scheda_pg = result_pg[0];
                                        if (Scheda_pg.Nome_Discord == message.author.id) {
                ...
                } else if (args[0] == "lingua") {                   // Event 4 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
                ...
                //         emit_print_err_internal(message);
                //     }
                } else if (args[0] == "creazione") {                // Event 6 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
                ...
                } else if (args[0] == "lavoro") {                   // Event 7 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
                ...
                } else if (args[0] == "token") {                    // Event 8 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
                ...
                } else if (args[0] == "fama") {                     // Event 9 fare
                    await connect_db("Event_config");
                    var config_timeskip = await methodDB.serachbyid_obj("1");
                    if (config_timeskip != null && config_timeskip != undefined) {
                        if (config_timeskip.Event_active == true) {
