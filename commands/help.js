...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (args[0] == "id") {
            ...
            message.channel.send(Container);
        } else if (args[0] == "ispirazione") {
            Container.setColor([255, 0, 0])
                .setTitle('Help Ispirazione')
                .setThumbnail(botavatar.displayAvatarURL())
                // .setDescription('Sintassi: **' + config.prefix + 'ispirazione** [Opzione][Valore][ID_Scheda] \n\n**OPZIONI**\n add = Aggiungi\n sub = Rimuovi\n\n Per aggiungere o toglire una ispirazione inserire opzione [Opzione], ammontare in [Valore], ID scheda utente in [ID_Scheda]');
                .setDescription('Sintassi: **' + config.prefix + 'ispirazione** [Opzione][Valore][@utenti] \n\n**OPZIONI**\n add = Aggiungi\n sub = Rimuovi\n\n Per aggiungere o toglire una ispirazione inserire opzione [Opzione], ammontare in [Valore], utente Discord in [@utente]');
            message.channel.send(Container);
